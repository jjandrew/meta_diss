...
class TestGAMuationClass(unittest.TestCase):
    ...
    """
    parent = [(0, 2, 1), (0, 2, 2), (1, 3, 3), (1, 3, 4)]
    ...
    def test_swap_deals_with_one_unique_deficit_node(self):
        ...
        for _ in range(iters):
            ...
            res = swap(parent=copy.copy(parent), mutation_rate=1)
    ...
    def test_swap_doesnt_mutate_when_mutation_rate_0(self):
        ...
        for _ in range(iters):
            ...
            res = swap(parent=copy.copy(self.parent), mutation_rate=0)
    ...
    def test_swap_always_when_mutation_rate_1(self):
        ...
        for _ in range(iters):
            ...
            res = swap(parent=copy.copy(self.parent), mutation_rate=1)
            # Ensure that the result is different to the parent
            self.assertNotEqual(self.parent, res)
            # Check that two pairs of two deficit nodes are present
            two_count = 0
            three_count = 0
            ...
            self.assertEqual(three_count, 2)
    ...
    def test_swaps_half_the_time_when_mutation_rate_half(self):
        ...
        for _ in range(iters):
            ...
            res = swap(parent=copy.copy(self.parent), mutation_rate=0.5)
